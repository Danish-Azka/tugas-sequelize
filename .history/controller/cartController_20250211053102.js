...
export const createCart= async (req, res) => {
    try{
        const {jumlah, harga, gambar, deskripsi, category,ShopId } = req.body;
        const product = await Cart.create({jumlah, harga, gambar, deskripsi, category,ShopId });
...
export const updateCart = async (req, res) => {
    try {
        ...
        await Cart.update({jumlah, harga, gambar, deskripsi, category,ShopId}, {
            where: { id }
        });
