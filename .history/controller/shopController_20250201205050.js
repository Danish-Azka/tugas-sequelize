...
export const createShop= async (req, res) => {
    try{
        ...
        const shop = await Shop.create({ tanggalPeminjaman, batasPeminjaman, durasiSewa, totalBiaya, MobilId , ClientId, KaryawanId});
...
export const updateShop = async (req, res) => {
    try {
        ...
        await shop.update({ tanggalPeminjaman, batasPeminjaman, durasiSewa, totalBiaya, MobilId, ClientId, KaryawanId }, {
            where: { id }
        });
