import Cart from "../models/productModel.js";
import Shop from "../models/shopModels.js";

export const createCart= async (req, res) => {
    try{
        const {nama, harga, gambar, deskripsi, category,ShopId } = req.body;
        const product = await Cart.create({nama, harga, gambar, deskripsi, category,ShopId });
...
export const updateCart = async (req, res) => {
    try {
        ...
        await Cart.update({nama, harga, gambar, deskripsi, category,ShopId}, {
            where: { id }
        });
