...
export const createProduct= async (req, res) => {
    try{
        const {nama, harga, gambar, deskripsi, comment,ShopId } = req.body;
        const product = await Product.create({nama, harga, gambar, deskripsi, comment,ShopId });
...
export const updateProduct = async (req, res) => {
    try {
        ...
        await Product.update({nama, harga, gambar, deskripsi, comment,ShopId}, {
            where: { id }
        });
