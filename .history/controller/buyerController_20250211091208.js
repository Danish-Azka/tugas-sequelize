...
export const createBuyer= async (req, res) => {
    try{
        const { nama, email, password,noTelp, saldo} = req.body;
        const buyer = await Buyer.create({ nama, email, password,noTelp, saldo});
...
export const updateBuyer = async (req, res) => {
    try {
        ...
        await buyer.update({ nama, email, password,noTelp, saldo }, {
            where: { id }
        });
