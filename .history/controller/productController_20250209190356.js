...
export const createProduct= async (req, res) => {
    try{
        const {nama, harga, gambar, deskripsi, categ,ShopId } = req.body;
        const product = await Product.create({nama, harga, gambar, deskripsi, categ,ShopId });
...
export const updateProduct = async (req, res) => {
    try {
        ...
        await Product.update({nama, harga, gambar, deskripsi, categ,ShopId}, {
            where: { id }
        });
