...
export const createCart= async (req, res) => {
    try{
        const {jumlah, totalHarga, BuyerId, cartId } = req.body;
        const cart = await Cart.create({jumlah, totalHarga, BuyerId, cartId });
...
export const updateCart = async (req, res) => {
    try {
        ...
        await Cart.update({jumlah, totalHarga, BuyerId, cartId}, {
            where: { id }
        });
