...
export const createCart= async (req, res) => {
    try{
        const {, harga, gambar, deskripsi, category,ShopId } = req.body;
        const product = await Cart.create({, harga, gambar, deskripsi, category,ShopId });
...
export const updateCart = async (req, res) => {
    try {
        ...
        await Cart.update({, harga, gambar, deskripsi, category,ShopId}, {
            where: { id }
        });
