...
export const createCart= async (req, res) => {
    try{
        const {jumlah, totalHarga, gambar, deskripsi, category,ShopId } = req.body;
        const product = await Cart.create({jumlah, totalHarga, gambar, deskripsi, category,ShopId });
...
export const updateCart = async (req, res) => {
    try {
        ...
        await Cart.update({jumlah, totalHarga, gambar, deskripsi, category,ShopId}, {
            where: { id }
        });
