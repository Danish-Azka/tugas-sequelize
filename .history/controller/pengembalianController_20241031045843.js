...
export const createPengembalian= async (req, res) => {
    try{
        const { tanggalPengembalia,n,TransaksiId, MobilId, ClientId, KaryawanId} = req.body;
        const transaksi = await Pengembalian.create({ tanggalPengembalian,,TransaksiId, MobilId , ClientId, KaryawanId});
