...
export const createCart= async (req, res) => {
    try{
        const {jumlah, totalHarga, BuyerId, Produ } = req.body;
        const product = await Cart.create({jumlah, totalHarga, BuyerId, Produ });
...
export const updateCart = async (req, res) => {
    try {
        ...
        await Cart.update({jumlah, totalHarga, BuyerId, Produ}, {
            where: { id }
        });
