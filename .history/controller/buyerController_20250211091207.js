...
export const createBuyer= async (req, res) => {
    try{
        const { nama, email, password,noT, saldo} = req.body;
        const buyer = await Buyer.create({ nama, email, password,noT, saldo});
...
export const updateBuyer = async (req, res) => {
    try {
        ...
        await buyer.update({ nama, email, password,noT, saldo }, {
            where: { id }
        });
