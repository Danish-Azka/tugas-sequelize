...
import { createS, getKaryawan, getKaryawanById, updateKaryawan, deleteKaryawan, getKaryawanByDivisi} from "../controller/karyawanController.js";
const karyawanRoute = express.Router();

karyawanRoute.post("/karyawan/post", createS)
